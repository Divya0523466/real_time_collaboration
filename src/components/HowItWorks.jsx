const steps = [
  ...
  },
  {
    ...
    description:
      "Communicate through real-time channel messaging or direct messages.",
  },
  {
    number: "05",
    icon: "fa-paperclip",
    ...
    description:
      "Share files and keep your team updated through real-time communication.",
  },
  {
    number: "06",
    icon: "fa-bell",
    ...
    description:
      "Receive notifications and see who's online or offline.",
  },
];
