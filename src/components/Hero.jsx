  ...
  return (
    <main className="mx-auto grid max-w-300 items-center gap-10 px-4 pb-8 pt-10 md:grid-cols-[0.9fr_1.1fr] md:gap-7 md:px-6 md:pt-12 lg:gap-12 lg:px-2 lg:pb-10 lg:pt-18">
      <section className="flex max-w-145 flex-col gap-4">
        <h1 className="text-4xl font-semibold leading-[1.08] tracking-tight text-[#25292a] md:text-4xl lg:text-5xl">Everything Your Team Needs to Stay Connected.</h1>
        <p className="max-w-125 text-lg leading-[1.45] text-[#52656a] lg:text-xl">Bring your team together with real-time messaging, organized channels, direct messages, file sharing, notifications, and presence - all in one workspace.</p>
