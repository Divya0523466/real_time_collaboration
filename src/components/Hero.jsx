  ...
  return (
    <main className="mx-auto grid max-w-300 items-center gap-10 px-4 pb-8 pt-10 md:grid-cols-[0.9fr_1.1fr] md:gap-7 md:px-6 md:pt-12 lg:gap-12 lg:px-2 lg:pb-10 lg:pt-18">
      <section className="flex max-w-145 flex-col gap-4">
        ...
        <p className="max-w-125 text-lg leading-[1.45] text-[#52656a] dark:text-[#A5C9CA] lg:text-xl">
        ...
        <div className="flex flex-wrap gap-4">
          <button
            ...
            className="cursor-pointer rounded-full bg-[#395B64] px-9 py-4 font-semibold text-white shadow-[0_10px_20px_rgba(57,91,100,0.22)] transition hover:bg-[#2C3333] dark:hover:bg-[#4E717B]"
          >
            Start Collaborating
          </button>
          ...
          <a
            href="#features"
            className="rounded-full border border-[#dbe4e4] dark:border-[#395B64] px-9 py-4 font-semibold text-[#303536] dark:text-[#E7F6F2] transition hover:bg-[#f1f7f6] dark:hover:bg-[#2C3333]"
          >
            Explore Features
          </a>
        </div>
      ...
      <img
        ...
        className="w-full max-w-180 justify-self-end object-contain rounded-2xl dark:border dark:border-[#2C3333] dark:shadow-[0_12px_40px_rgba(0,0,0,0.4)] transition"
      />
    </main>
  );
};
