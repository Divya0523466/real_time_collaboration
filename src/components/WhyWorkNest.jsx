...
const benefits = [
  [
    "01",
    "Stay Connected",
    "Keep your team connected through real-time conversations.",
  ],
  [
    "02",
    "Organize Conversations",
    "Use workspaces and channels to keep communication structured.",
  ],
  [
    "03",
    "Communicate Instantly",
    "Send and receive messages in real time without refreshing.",
  ],
  [
    "04",
    "Share Everything",
    "Share files directly within conversations and keep important information accessible.",
  ],
];
    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-300">
        <header className="mx-auto max-w-190 text-center">
          <p className="text-sm font-bold tracking-[0.2em] text-[#A5C9CA]">
            WHY WORKNEST
          </p>
        ...
        <div className="mt-12 grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="order-2 text-left">
            {benefits.map(([number, title, description]) => (
              <article
                key={number}
                className="flex gap-5 border-t border-[rgba(165,201,202,0.2)] py-5"
              >
                <span className="pt-1 text-sm font-bold tracking-[0.15em] text-[#A5C9CA]">
                  {number}
                </span>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#A5C9CA]">
                    {description}
                  </p>
                </div>
              </article>
