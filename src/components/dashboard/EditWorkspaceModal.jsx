    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-5">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#395B64] dark:text-[#A5C9CA]">Workspace Settings</p>
            <h2 className="text-xl font-bold text-[#2C3333] dark:text-[#E7F6F2]">Edit Workspace</h2>
          </div>
          <button
            type="button"
            onClick={onClose}
